      ...
      >
        ...
        <View style={styles.titleSection}>
          ...
          <Text style={styles.subtitle}>
            ...
            Get solar for your <Text style={styles.boldText}>Home</Text>
          </Text>
        </View>
        ...
        <View style={styles.pricingSection}>
          <Text style={styles.pricingTitle}>
            You are paying high prices for{'\n'}
            </Text> <Text style={styles.pricingTitle1}>
            electricity, Which is often unreliable
          </Text>
        ...
        <View style={styles.pricingSection}>
          ...
          But now you can control the <Text style={styles.boldText}>electricity bills</Text> and get <Text style={styles.boldText}>hugh savings Because</Text> {'\n'}
          <Text style={styles.boldText}>solar is already cheaper</Text> than you think
          </Text>
          <Text style={styles.modeltxt}>Different Models Available</Text>
          
          <View style={styles.pricingGrid}>
            <TouchableOpacity style={styles.pricingCard2}>
            <Text style={styles.modelLabel}>One Time Investment</Text>

            <Image source={require("../assets/3.png")} style={styles.modelimg}/>
            <Text style={styles.priceLabel}>✔ Initial Investment</Text>
              <Text style={styles.priceLabel}>✔ Zero Electricity Bill*</Text>
            </TouchableOpacity>
            
            <TouchableOpacity style={styles.pricingCard2}>
            <Text style={styles.modelLabel}>Zero Investment</Text>

               <Image source={require("../assets/1.png")} style={styles.modelimg}/>
              <Text style={styles.priceLabel}>✔ Zero Initial Investment*</Text>
              <Text style={styles.priceLabel}>✔ Monthly Solar Electricity Bill</Text>
            </TouchableOpacity>
        ...
        <View style={styles.worktxtview}>
          <Text style={styles.worktxt}>How it Works?</Text>
        </View>
        <View style={styles.workGrid}>
          <TouchableOpacity style={styles.workCard}>
            <AntDesign name="filetext1" size={28} color="#000" style={styles.workimg}/>
            <Text style={styles.workText}>Get Instant Estimate</Text>
          </TouchableOpacity>
          
          <TouchableOpacity style={styles.workCard}>
          <Image source={require("../assets/plumber.png")} style={styles.workimg}/>
          <Text style={styles.workText}>Request for Site Suvery</Text>
          </TouchableOpacity>
          
          <TouchableOpacity style={styles.workCard}>
          <Image source={require("../assets/justice-scale.png")} style={styles.workimg}/>
            <Text style={styles.workText}>Compare & Select</Text>
          </TouchableOpacity>
          
          <TouchableOpacity style={styles.workCard}>
          <Image source={require("../assets/coffee.png")} style={styles.workimg}/>
            <Text style={styles.workText}>Sit back & Relax</Text>
          </TouchableOpacity>
        </View>
